    ...
    plans: [
      {
        ...
        features: [
          ...
          { text: "Portal integration (99acres, MagicBricks)", included: true },
          ...
          { text: "Stage-wise payments", included: false },
          ...
          { text: "AI Sales Forecasting", included: false, isAI: true },
          { text: "AI Calling Assistant", included: false, isAI: true },
        ],
      },
      {
        id: "growth",
    ...
    plans: [
      {
        ...
        features: [
          ...
          { text: "1 project", included: true },
          { text: "Task management", included: true },
          { text: "Portal integration", included: true },
          { text: "Site visit scheduling", included: true },
          { text: "Mobile app", included: true },
          { text: "Team pipeline (up to 4)", included: true },
          { text: "Website lead integration", included: false },
          { text: "Email integration", included: false },
          { text: "WhatsApp + SMS integration", included: false },
          { text: "Mass email campaigns", included: false },
          { text: "IVR integration", included: false },
          { text: "AI Lead Scoring", included: true, isAI: true },
          { text: "AI Follow-up Suggestions", included: true, isAI: true },
          { text: "AI Sales Forecasting", included: false, isAI: true },
          { text: "AI Email Writer", included: false, isAI: true },
        ],
      },
      {
        id: "growth",
        name: "Growth",
        monthlyPrice: 1499,
        desc: "Everything you need to grow your brokerage.",
        featured: false,
        ctaText: "Start Free Trial",
        ctaHref: "",
        features: [
          ...
          { text: "Site visit scheduling", included: true },
          { text: "Mobile app", included: true },
          { text: "Team pipeline (up to 8)", included: true },
      ...
      },
      {
        ...
        name: "Professional",
        monthlyPrice: 2999,
        desc: "Advanced tools for growing broker teams.",
        featured: true,
        ctaText: "Start Free Trial",
        ctaHref: "",
        features: [
          ...
          { text: "Site visit scheduling", included: true },
          { text: "Mobile app", included: true },
          { text: "Team pipeline (up to 15)", included: true },
          { text: "Website lead integration", included: true },
          { text: "Email integration", included: true },
          { text: "WhatsApp + SMS integration", included: true },
          { text: "Mass email campaigns", included: true },
          { text: "IVR integration", included: false },
          { text: "AI Lead Scoring", included: true, isAI: true },
          { text: "AI Follow-up Suggestions", included: true, isAI: true },
          { text: "AI Sales Forecasting", included: true, isAI: true },
          { text: "AI Email Writer", included: true, isAI: true },
        ],
      },
      {
        id: "scale",
        name: "Scale",
        monthlyPrice: null,
        desc: "Tailored for large brokerage firms.",
        featured: false,
        ctaText: "Talk to Sales",
        ctaHref: "#demo",
        features: [
          ...
          { text: "Site visit scheduling", included: true },
          { text: "Mobile app", included: true },
          { text: "Team pipeline (unlimited)", included: true },
          { text: "Website lead integration", included: true },
          { text: "Email integration", included: true },
          { text: "WhatsApp + SMS integration", included: true },
          { text: "Mass email campaigns", included: true },
    ...
    plans: [
      {
        ...
        name: "Starter",
        monthlyPrice: 899,
        desc: "Perfect for small mandate firms getting started.",
        featured: false,
        ctaText: "Start Free Trial",
        ctaHref: "",
        features: [
          ...
          { text: "Inventory management", included: false },
          { text: "Document management", included: false },
          { text: "Website templates", included: false },
          { text: "Custom workflows", included: false },
          { text: "Multi-branch management", included: false },
          { text: "AI Lead Scoring", included: true, isAI: true },
          { text: "AI Opportunity Insights", included: false, isAI: true },
          { text: "AI Report Generator", included: false, isAI: true },
          { text: "AI Predictive Analytics", included: false, isAI: true },
        ],
      },
      {
        id: "growth",
        name: "Growth",
        monthlyPrice: 1699,
        desc: "Everything you need to scale your mandate business.",
        featured: false,
        ctaText: "Start Free Trial",
        ctaHref: "",
        features: [
      ...
      },
      {
        ...
        name: "Professional",
        monthlyPrice: 3199,
        desc: "Advanced tools for larger mandate operations.",
        featured: true,
        ctaText: "Start Free Trial",
        ctaHref: "",
        features: [
      ...
      },
      {
        ...
        name: "Scale",
        monthlyPrice: null,
        desc: "Tailored for large mandate organizations.",
        featured: false,
        ctaText: "Talk to Sales",
        ctaHref: "#demo",
        features: [
